...
http.createServer((req, res) => {
    ...
    //endpoint - /users
    //method: "GET"
    //response should return from the mock data
    ...
    //endpoint - /users
    //method: "POST"
    //response should return the data that is being inserted in our mock data array
    ...
    if(req.url == '/users' && req.method == 'POST'){
        ...
        req.on("end", () =>{
            //parse reqBody tp Javascript object so that we can insert it to the mock database
